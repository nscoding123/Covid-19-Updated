...
function preload() {
  ...
  readMeImg = loadImage("COVID19GAME.png");
...
function setup() {
  ...
  readMe = createSprite(width/2, (height/2)-80);
...
virusGroup.setVelocityEach(12,0);
  shotGroup.setVelocityEach(-6,0);
  greyV.setVelocityEach(12,0);
  pinkV.setVelocityEach(12,0);
  blueV.setVelocityEach(12,0);
  yellowV.setVelocityEach(12,0);
  ground.velocityX=-4;
  }
  */
    //new code added
